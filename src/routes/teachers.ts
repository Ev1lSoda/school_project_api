...
export default class Teachers {
  ...
  public initializeRoute() {
    ...
    this.router.get("/getTargetMathTeachers", (req: express.Request, res: express.Response) => {
      this.sqlQueries.getTargetMathTeachers().then((rez) => res.status(200).json({ ok: true, results: rez }));
    });
  }
}
